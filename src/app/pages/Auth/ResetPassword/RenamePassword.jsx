...
const RenamePassword = ({ isLoading }) => {
  ...
  return (
    !isLoading && (
      <>
        {/* <InitialPage /> */}
        <div style={{ backgroundColor: mode === "light" ? "" : "#303030", height: "100vh", display: "flex",alignItems:"center",padding:"5rem" }}>
          <Grid
            container
            sx={{
              display: 'grid',
          ...
          >
            <Stack>
              <div style={{ display: 'grid', justifyContent: 'center' }}>
                <Typography variant='h4' component='h2' sx={{ color: mode === "light" ? "" : "#ffff" }}>
                  Create Password <LockPersonIcon sx={{ fontSize: '2rem' }} />
                </Typography>
                <br />
                <p style={{ color: mode === "light" ? "" : "#ffff" }}>Password must contain :</p>
                <ValidationItem
                ...
                <TextField
                  ...
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position='end'>
                        <Tooltip
                          title={`Show ${showConfirmPassword ? 'Hidden' : 'Visible'
                            } Confirm Password`}
                        >
                          <IconButton
                            aria-label='toggle password visibility'
