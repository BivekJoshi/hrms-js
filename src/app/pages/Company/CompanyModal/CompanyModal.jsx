...
import AssignCompanyFields from '../../../components/Form/Company/AssignCompanyFields';
...
export const EditAssignCompanyModal = ({ open, handleCloseModal, data, title }) => {
  // const { data } = useGetCompanyById(id);
  return (
    <Box>
      <FormModal
        ...
        open={open}
        onClose={handleCloseModal}
        formComponent={<AssignCompanyFields onClose={handleCloseModal} data={data} />}
      />
    </Box>
  );
};