...
const EmailToAll = ({ getEventID, onClose }) => {
  ...
  const handleChange = (event) => {
    ...
    switch (value) {
      case "all":
        allEmployeeId = employeeData.map((employee) => employee.id);
        break;
      case "male":
        allEmployeeId = getMaleEmployeeById();
        break;
      case "female":
        allEmployeeId = getFemaleEmployeeById();
        break;
      case "technical":
        allEmployeeId = getTechnicalEmployeeById();
        break;
      case "businessa":
        allEmployeeId = getBusinessAEmployeeById();
        break;
      case "businessb":
        allEmployeeId = getBusinessBEmployeeById();
        break;
      default:
        allEmployeeId = value;
    }
  ...
  //   all: employeeData.map((employee) => employee.id),
  //   male: getMaleEmployeeById(),
  //   female: getFemaleEmployeeById(),
  //   technical: getTechnicalEmployeeById(),
  //   businessa: getBusinessAEmployeeById(),
  //   businessb: getBusinessBEmployeeById(),
  // };
  ...
  // const handleChange = (event) => {
  //   const { value } = event.target;
  //   setEmployeeId(employeeDataMap[value] || value);
  // };
