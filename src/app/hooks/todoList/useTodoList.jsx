...
import { addTodoList, deleteTodoList, editTodoList, getTodoList, getTodoListById, getTodoListByUserId } from '../../api/todoList/toDo-api';
...
export const useGetTodoListByUserId = (userId) => {
    return useQuery(["getTodoListByUserId", userId], () => getTodoListByUserId(userId), {
        refetchInterval: false,
        refetchOnWindowFocus: false,
    })
};
...
export const useEditTodoList = ({ onSuccess }) => {
    const queryClient = useQueryClient();
    return useMutation(["editTodoList"], (formData, id) => editTodoList(formData, id), {
