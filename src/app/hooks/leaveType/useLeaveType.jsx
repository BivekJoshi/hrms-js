...
import { addLeaveType, deleteLeaveType, editLeaveType, getLeaveType, getLeaveTypeById } from '../../api/leaveType/leaveType-api';
...
export const useDeleteLeaveType = ({ onSuccess }) => {
  const queryClient = useQueryClient();
  return useMutation(['deleteLeaveType'], (leavetypeId) => deleteLeaveType(leavetypeId), {
    onSuccess: (data, variables, context) => {
...
export const useEditLeaveType = ({ onSuccess }) => {
    const queryClient = useQueryClient();
    return useMutation(['editLeaveType'],
      (formData) => editLeaveType(formData),
      {
        onSuccess: (data, variables, context) => {
