...
import { addDesignation, deleteDesignation, editDesignation, getDesignation, getDesignationById } from '../../api/designation/designation-api';
...
export const useDeleteDesignation = ({ onSuccess }) => {
  const queryClient = useQueryClient();
  return useMutation(['deleteDesignation'], (designationId) => deleteDesignation(designationId), {
    onSuccess: (data, variables, context) => {
...
export const useEditDesignation = ({ onSuccess }) => {
  const queryClient = useQueryClient();
  return useMutation(['editDesignation'],
