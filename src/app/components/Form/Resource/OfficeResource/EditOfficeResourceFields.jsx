...
import useEditOfficeResourceForm from "../../../../hooks/resource/officeResource/useEditOfficeResourceForm";

const EditOfficeResourceFields = ({ onClose, isLoading ,data}) => {
  
    const { formik } = useEditOfficeResourceForm(data);
...
export default EditOfficeResourceFields;
