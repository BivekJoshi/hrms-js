                      ...
                      <Grid container spacing={3} key={index}>
                        <Grid item xs={12} sm={6} md={4}>
                          <TextField
                            ...
                            InputLabelProps={{
                              shrink: Boolean(formik.values.addresses?.[index]?.country),
                            }}
                            variant="outlined"
                            size="small"
                          >
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                          <TextField
                            ...
                            InputLabelProps={{
                              shrink: Boolean(formik.values.addresses?.[index]?.province),
                            }}
                            variant="outlined"
                            size="small"
                          >
                          ...
                          <Autocomplete
                            ...
                            renderInput={(params) => (
                              <TextField
                                ...
                                InputLabelProps={{
                                  shrink: Boolean(formik.values.addresses?.[index]?.district),
                                }}
                                variant="outlined"
                                size="small"
                              />
                          ...
                          <Autocomplete
                            ...
                            renderInput={(params) => (
                              <TextField
                                ...
                                InputLabelProps={{
                                  shrink: Boolean(formik.values.addresses?.[index]?.municipality),
                                }}
                                variant="outlined"
                                size="small"
                              />
                        ...
                        <Grid item xs={12} sm={6} md={2}>
                          <TextField
                            ...
                            InputLabelProps={{
                              shrink: Boolean(formik.values.addresses?.[index]?.wardNumber),
                            }}
                            variant="outlined"
                            size="small"
                          />
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                          <TextField
                            ...
                            InputLabelProps={{
                              shrink: Boolean(formik.values.addresses?.[index]?.city),
                            }}
                            variant="outlined"
                            size="small"
                          />
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                          <TextField
                            ...
                            InputLabelProps={{
                              shrink: Boolean(formik.values.addresses?.[index]?.street),
                            }}
                            variant="outlined"
                            size="small"
                          />
